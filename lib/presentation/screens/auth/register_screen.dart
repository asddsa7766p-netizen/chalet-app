      ...
      if (mounted) {
        showDialog(
          ...
          builder: (_) => AlertDialog(
            ...
            title: const Text('تم إنشاء الحساب! ✅', style: TextStyle(fontFamily: 'Cairo', fontWeight: FontWeight.w700)),
            content: const Text('تم إنشاء حسابك بنجاح. يرجى تأكيد بريدك الإلكتروني ثم تسجيل الدخول.', style: TextStyle(fontFamily: 'Cairo')),
            actions: [
              TextButton(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextField(controller: _nameCtrl, label: AppStrings.fullName,
                hint: 'محمد أحمد', prefixIcon: Icons.person_outline,
                validator: (v) => (v?.isEmpty ?? true) ? AppStrings.fieldRequired : null),
              const SizedBox(height: 14),

              CustomTextField(controller: _emailCtrl, label: AppStrings.email,
              ...
              CustomTextField(controller: _phoneCtrl, label: AppStrings.phone,
                hint: '05xxxxxxxx', prefixIcon: Icons.phone_outlined,
                keyboardType: TextInputType.phone,
                validator: (v) => (v?.isEmpty ?? true) ? AppStrings.fieldRequired : null),
              const SizedBox(height: 14),

              CustomTextField(controller: _passwordCtrl, label: AppStrings.password,
                hint: '••••••••', prefixIcon: Icons.lock_outline,
              ...
              CustomTextField(controller: _confirmCtrl, label: AppStrings.confirmPassword,
                hint: '••••••••', prefixIcon: Icons.lock_outline,
                ...
                validator: (v) {
                  if (v?.isEmpty ?? true) return AppStrings.fieldRequired;
                  if (v != _passwordCtrl.text) return AppStrings.passwordsNotMatch;
                  return null;
                }),
              ...
              AppButton(label: AppStrings.register, onPressed: _register, loading: _loading),
              const SizedBox(height: 16),
  ...
  Widget _buildFormView() => Form(
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 28),
        AppButton(label: AppStrings.sendResetLink, onPressed: _sendReset, loading: _loading),
        const SizedBox(height: 16),
        TextButton(
          onPressed: () => context.pop(),
          child: const Text('العودة لتسجيل الدخول',
            style: TextStyle(color: AppColors.primary, fontFamily: 'Cairo', fontWeight: FontWeight.w600)),
        ),
      ],
    ),
  );
  ...
  Widget _buildSuccessView() => Column(
    children: [
      ...
      Container(
        ...
        child: const Icon(Icons.check_rounded, size: 54, color: AppColors.success),
      ),
      const SizedBox(height: 28),
      ...
      Padding(
        ...
        child: Text('تم إرسال رابط إعادة تعيين كلمة المرور إلى ${_emailCtrl.text}',
          textAlign: TextAlign.center,
          style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: AppColors.textSecondary)),
      ),
